...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        // 查询出所有的搜索规格参数
        List<SpecParam> params = this.specificationClient.queryParma(null, spu.getCid3(), null, true);
        // 查询spuDetail。获取规格参数值
    ...
    private BoolQueryBuilder buildBoolQueryBuilder(SearchRequest request) {
        ...
        for (Map.Entry<String, Object> enter : filter.entrySet()) {
            ...
            boolQueryBuilder.filter(QueryBuilders.termQuery(key, enter.getValue()));
        }
    ...
    private List<Map<String, Object>> getParamAggResult(Long cid, QueryBuilder basicQuery) {
        ...
        //查询要聚合的规格参数
        List<SpecParam> params = this.specificationClient.queryParma(null, cid, null, true);
        ...
        //解析聚合结果集, key-聚合参数名 value-聚合对象
        Map<String, Aggregation> aggregationMap = goodsPage.getAggregations().asMap();
        for (Map.Entry<String, Aggregation> entry : aggregationMap.entrySet()) {
            //初始化map k: 规格参数名 option: 聚合的规格参数名
